...
class PlanningGraph():
    ...
    def add_action_level(self, level):
        ...
        prev_s_level = self.s_levels[level] #previous state level
        actions = self.all_actions #list of possible actions
        self.a_levels.append(set()) #initialize level of action
    ...
    def add_literal_level(self, level):
        ...
        # 2. connect the nodes
        prev_a_level = self.a_levels[level - 1] # get previous action level
        self.s_levels.append(set()) # initialize level of states
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # check if actions from node 1 are negated by action of node 2 and vice versa
        return bool(
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        :return: bool
        """
        # check if action of node 1 is negation of node 2 precondition and vice versa
        return bool(

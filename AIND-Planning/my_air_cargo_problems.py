...
class AirCargoProblem(Problem):
    ...
    def actions(self, state: str) -> list:
        ...
        :return: list of Action objects
        """
        #store propositional logic expressions from knowledge base
        kb = PropKB()
        # add current state positive sentences clauses to knowledge base
    ...
    def result(self, state: str, action: Action):
        ...
        # Based upon action's add/remove effects of previous states, we determine how fluents to be carried to new state
        ...
        # If action effect is add then add fluent to positive sentences and if effect is rem then add fluent to negative sentences 
